    ...
    pub fn execute(
        ...
        unsafe {
            ...
            if !B::can_push_graphics_constants() {
                let head = crate::simulation::Instance {
                    x_offset: render_area.w as f32,
                    y_offset: render_area.h as f32,
                    highlight: 0,
                    z: 0.0,
                };
                ...
                for model in models.iter() {
                    ...
                    ub_idc.push(
                        resource_manager
                            .write_temp_uniform_buffer_with_descriptor(&write)
                            .expect("failed writing to temp uniform buffer"),
                    );
                }
            }
                ...
                if B::can_push_graphics_constants() {
                    ...
                    encoder.bind_graphics_descriptor_sets(
                        ...
                        vec![
                            desc.unwrap(),
                            resource_manager
                                .get_temp_buffer_descriptor(ub_idc[ub_idx])
                                .unwrap(),
                        ],
                        &[],
                    );
